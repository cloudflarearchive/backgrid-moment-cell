...
b(a._,a.Backgrid,a.moment)}(this,function(a,b,c){"use strict";var d={},e=d.MomentFormatter=b.Extension.MomentFormatter=function(b){a.extend(this,this.defaults,b)};e.prototype=new b.CellFormatter,a.extend(e.prototype,{/**
     ...
     */
defaults:{modelInUnixOffset:!1,modelInUnixTimestamp:!1,modelInUTC:!0,modelLang:c.locale(),modelFormat:c.defaultFormat,displayInUnixOffset:!1,displayInUnixTimestamp:!1,displayInUTC:!0,displayLang:c.locale(),displayFormat:c.defaultFormat},/**
